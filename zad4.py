...
def main():
	...
	st.set_page_config(page_title="Przewidywanie Przetrwania na Titanicu")
	overview = st.container()
	left, right = st.columns(2)
	prediction = st.container()

	st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Titanic_in_color.png/1280px-Titanic_in_color.png")

	with overview:
		st.title("Przewidywanie Przetrwania na Titanicu")
